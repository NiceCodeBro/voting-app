    ...
    render() {
        return (
            <div>
                ...
                <br/>
                {
                    this.props.feeds.map((feed) => <FeedComponent key={uuid()} feed={feed} hasActions={true} onDeleteClicked={(aFeedId) => this.props.deleteFeed(aFeedId, this.props.userCredentials.token)}/>)
                }
            </div>
      )
    }
